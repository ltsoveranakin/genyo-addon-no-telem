...
public class GenyoAutoCityV2 extends GenyoModule {
    ...
    public GenyoAutoCityV2() {
        super(Genyo.WORLD, "Genyo AutoCityV2", "Automatically cities players");
    }
