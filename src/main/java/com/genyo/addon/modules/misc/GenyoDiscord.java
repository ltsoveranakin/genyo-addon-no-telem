...
public class GenyoDiscord extends GenyoModule {
    ...
    private final Setting<List<String>> line2Strings = sgLine2.add(new StringListSetting.Builder()
        ...
        .defaultValue("genyo!", "{round(server.tps, 1)} TPS", "genyoo", "{server.player_count} Players online")
    ...
    private enum SmallImage {
        ...
        SmallImage next() {
            if (this == Hulkenberg) return Mario;
            return Hulkenberg;
        }
    }
