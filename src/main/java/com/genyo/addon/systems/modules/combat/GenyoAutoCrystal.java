...
import com.genyo.addon.systems.modules.world.GenyoAutoMine;
import com.genyo.addon.systems.modules.world.GenyoSurroundV2;
        ...
        for (Entity crystal : entities)
        {
            ...
            for (Entity entity : entities)
            {
                    ...
                    && !BlastResistantBlocks.isUnbreakable(player.getBlockPos()))
                {
                    ...
                    if (Modules.get().isActive(GenyoAutoMine.class) && miningBlock != null)
                    {
