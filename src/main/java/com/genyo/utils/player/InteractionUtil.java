...
public class InteractionUtil {
    ...
    public static BlockHitResult getPlaceResult(@NotNull BlockPos bp, Interact interact, boolean ignoreEntities) {
        ...
        if (interact == Interact.AirPlace)
            return ExplosionUtil.rayCastBlock(new RaycastContext(getEyesPos(mc.player), bp.toCenterPos(), RaycastContext.ShapeType.COLLIDER, RaycastContext.FluidHandling.NONE, mc.player), bp);
